...
STATIC = {'index.html', 'styles.css', 'theme.js', 'xyz.js', 'ase-model.js', 'fit.js', 'pbc.js', 'plot.js', 'browser-bridge.js',
          'units.js', 'qm-resolve.js', 'qm-inputs.js', 'qm-panel.js', 'viewer.js', 'app-core.js', 'app-workflow.js', 'app-analysis.js', 'app-geometry.js', 'app-mdanalysis.js', 'app-structure.js', 'app-history.js', 'app-start.js', 'provenance.js', 'console.js', 'report.js', 'replaygen.js', 'analysis-forms.js', 'examples/water.XYZ'}
